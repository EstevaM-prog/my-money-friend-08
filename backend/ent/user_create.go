...
func (_c *UserCreate) AddBudgetRuleIDs(ids ...int) *UserCreate {
	_c.mutation.AddBudgetRuleIDs(ids...)
	return _c
}

// AddBudgetRules adds the "budget_rules" edges to the BudgetRule entity.
func (_c *UserCreate) AddBudgetRules(v ...*BudgetRule) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddBudgetRuleIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.BudgetRulesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
